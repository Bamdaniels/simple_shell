 ...
 *
 * Return: This is said to return bytes read
 */
...
/**
 * read_buf - This reads a buff
 * @info: This is the parameter struct
 * @buf: Here is a buff
 * @i: This is the size
 *
 * Return: r is said to be returned
 */
...
/**
 * _getline - This gets the next line of input from Standard input
 * @info: Here is the parameter struct
...
/**
 * sigintHandler - This actually blocks ctrl-C
