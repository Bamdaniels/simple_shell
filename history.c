...
/**
 * history_file -This gets history file
 * @info: parameter structures
 *
 * Return:It will return the allocated string containing history file
 */
...
/**
 * write_history - It creates a file, or appends to already existing file
